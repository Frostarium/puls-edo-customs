...
function s.initial_effect(c)
    ...
    --Quick effect version if Pandaemonium is on field
...
function s.spcon(e,c)
    ...
    return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
        ...
        or Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,62400006),tp,LOCATION_FZONE,0,1,nil))
end

function s.quickcon(e,tp,eg,ep,ev,re,r,rp)
    return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,62400006),tp,LOCATION_FZONE,0,1,nil)
end
