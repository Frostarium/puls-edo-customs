...
function s.negcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_FZONE,0,1,nil,62400006)
		and rp~=tp and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED)
